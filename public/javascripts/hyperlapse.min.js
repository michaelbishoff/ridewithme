...
var Hyperlapse = function(container, params) {
  ...
  var handleSaveFramesComplete = function(e) {
    console.log('Triggering save frames complete');
/*
    console.log('render data length: ' + _renderData.length);
    console.log(_renderData);

    $.ajax({
      url: '/createframes/' + self.uniqueName,
      type: 'POST',
      data: JSON.stringify(_renderData),
    ...
    //if (self.onSaveFramesComplete) self.onSaveFramesComplete(self.uniqueName);
  }
  ...
  var animate = function() {
    ...
    if (_is_playing) {
      ...
      /*_renderData.push(*/{
        ...
        frame: render_frame++,
        file: _renderer.domElement.toDataURL()
      });
    }
  };
